type OptionalInfo = { description: string }

export interface ITaste {
  name: string[];
  isLike: IS_LIKE;
  optional: Array<OptionalInfo>
}
...
export const DISLIKE_LIST: ITaste[] = [
  {
    name: [
      "ばらの匂い", "ばらのにおい", "バラノニオイ",
      "ばらの香り", "ばらのかおり", "バラノカオリ"
...
export const CONDITIONAL_LIST: ITaste[] = [
  {
    name: ["鰹節", "かつおぶし", "カツオブシ"],
